...
\newcommand{\pubsss}[4]{\pubref{\ref{#1}, \ref{#2}, \ref{#3}, \ref{#4}}}
...
% #9: pages
% #10: BibTeX
\newcommand{\journal}[9]{\pubitem{#1} #2 (#3), ``\ifempty{#4}{\textcolor{blue}{#5}}{\newtabhref{#4}{#5}}'', \textit{\glsfirst{#6}}. \ifempty{#7}{\textbf{(\ifempty{#4}{to appear}{online})}}{#7\ifnotempty{#8}{(#8)}:#9.}\journalcontinued}
...
\newacronym[first={Artificial Intelligence Lab.\@ Recod.ai}]{recod}{Recod.ai}{??}
