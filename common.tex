...
\newcommand{\speciallink}[2]{\href{#1}{[#2]}}
...
% #8: BibTeX
\newcommand{\arxiv}[8]{\label{#1} #2 (#3), ``\newtabhref{#4#5}{#6}'', \emph{arXiv:#5}. \ifempty{#7}{\textbf{(unpublished)}}{\textbf{(submitted to} \glsfirst{#7}\textbf{)}} \bibtex{#8}}
...
% Proceedings
\newacronym{wuwsibgrapi}{SIBGRAPI}{Workshop of Undergraduate Work, Conference on Graphics, Patterns and Image}
...
\newacronym{icip}{ICIP}{IEEE Intl. Conference on Image Processing}
