...
\newcommand{\arxiv}[7]{\label{#1} #2 (#3), ``\newtabhref{#4#5}{#6}'', \emph{arXiv:#5}. \ifempty{#7}{\textbf{(to be submitted)}}{\textbf{(submitted to} \glsfirst{#7}\textbf{)}}}
...
I am a PhD candidate at \gls{unicamp}, working mainly with recognition in open-set scenarios, developing methods that can be applied to general open-set problems \ref{ref:MendesJunior2016} \ref{ref:MendesJunior2016a}.
...
Through \gls{ufop-en} I obtained a bachelor's degree in Computer Science \ref{ref:MendesJunior2012}.
During the undergraduate, I worked mainly with digital image processing and in the specific problem of vehicle license plate location \ref{ref:MendesJunior2011} and I concluded my education studying the Haskell functional programming language for image processing \ref{ref:MendesJunior2012}.
Currently, I am working at \gls{uccs} as a research assistant investigating open-set recognition.
...
Feature vectors used in \ref{ref:MendesJunior2016}: \myurl{https://dx.doi.org/10.6084/m9.figshare.1097614}.
...
\item\journal{ref:MendesJunior2016}
  {
    \gls{me}
