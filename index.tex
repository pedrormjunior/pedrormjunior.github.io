...
% #7: pages
% #8: BibTeX
\newcommand{\proceedings}[8]{\label{#1} #2 (#3), ``\ifempty{#4}{\underline{\textcolor{blue}{#5}}}{\href{#4}{#5}}'', In: \emph{\glsfirst{#6}}.\ifnotempty{#7}{ pp. #7.} \bibtex{#8}}
...
% #8: filing date
% #9: publication date
\newcommand{\patent}[9]{\label{#1} #2 (#3), ``\ifempty{#4}{\underline{\textcolor{blue}{#5}}}{\href{#4}{#5}}'', \emph{\glsfirst{#6}}. \glsfirst{#7}: #8. Filing date: #9.\patentcontinue}
