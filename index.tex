...
\newacronym{recod}{RECOD}{Reasoning for Complex Data lab}
...
I am a Ph.D. candidate at \gls{unicamp}, working mainly with recognition in open-set scenarios, developing methods that can be applied to general open-set problems \ref{ref:MendesJunior2017} \ref{ref:MendesJunior2016a}.
...
I have worked at \gls{uccs} as a research assistant investigating open-set recognition for one year.
